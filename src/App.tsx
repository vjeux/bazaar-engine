...
import { run, getTooltips, TICK_RATE, GameState, BoardCard } from "./Engine.ts";
...
import { Tier, V2Card, V2Cards } from "./types/cardTypes.ts";
...
function BoardCardElement({ boardCard, gameState, playerID, boardCardID }) {
...
function BoardSkillElement({ boardCard, gameState, playerID, boardCardID }) {
  const card = boardCard.card;
  const tier = boardCard.tier;
